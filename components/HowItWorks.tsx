...
const stages = [
  ...
  },
  {
    ...
    colorStyle: {
      ...
      badgeText: 'text-[#060F12]merald-400',
    }
  },
  {
    num: '03',
    ...
    <section id="how-it-works" className="py-20 bg-transparent border-t border-[#172B33]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-sm sm:text-[#060F12]ase text-[#7FA0AB]">
        ...
        <div className="space-y-4 max-w-4xl mx-auto">
          {stages.map((stage) => {
            ...
            return (
              ...
              >
                {/* Number / Icon Badge */}
                <div className={`w-12 h-12 rounded-2xl border flex items-center justify-center font-mono-label font-bold text-[#060F12]ase flex-shrink-0 ${style.iconBg} ${style.iconBorder} ${style.iconColor}`}>
