    ...
    <section id="how-it-works" className="py-20 bg-transparent border-t border-[#9CB4BD]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-sm sm:text-[#0F6F8A]ase text-[#425E67]">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="text-xl font-bold font-serif-heading text-[#06151A]">
                      {stage.title}
                    </h3>
                  ...
                  <p className="text-sm sm:text-[#0F6F8A]ase text-[#425E67] leading-relaxed">
                    {stage.desc}
                  </p>
                </div>
              </div>
