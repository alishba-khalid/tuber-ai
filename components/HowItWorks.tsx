...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-20 bg-transparent border-t border-[#1E434F]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-sm sm:text-[#8FE1F4]ase text-[#92B5C0]">
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm sm:text-[#8FE1F4]ase text-[#92B5C0] leading-relaxed">
                    {stage.desc}
                  </p>
                </div>
              </div>
