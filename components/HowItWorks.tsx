...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-20 bg-transparent border-t border-[#E5E2D8]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg font-semibold text-[#18181B] mb-2">
        ...
        <div className="space-y-4 max-w-4xl mx-auto">
          {stages.map((stage) => {
            ...
            return (
              ...
              >
                {/* Number / Icon Badge */}
                <div className="w-12 h-12 rounded-2xl bg-[#EEF2FF] border border-[#C7D2FE] flex items-center justify-center text-[#1E1B4B] font-mono-label font-bold text-base flex-shrink-0">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="text-xl font-bold font-serif-heading text-[#18181B]">
                      {stage.title}
                    </h3>
                    <span className="text-xs font-mono-label font-bold text-[#1E1B4B] bg-[#EEF2FF] px-2.5 py-1 rounded-full border border-[#C7D2FE]">
                      AUTOMATED
                    </span>
                  </div>
