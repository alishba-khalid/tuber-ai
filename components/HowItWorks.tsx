...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-20 bg-transparent border-t border-[#133038]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg font-semibold text-[#E2F8FC] mb-2">
            One topic in. A finished video out.
          </p>
          <p className="text-sm sm:text-[#9FE8FA]ase text-[#678B94]">
        ...
        <div className="space-y-4 max-w-4xl mx-auto">
          {stages.map((stage) => {
            ...
            return (
              ...
              >
                {/* Number / Icon Badge */}
                <div className="w-12 h-12 rounded-2xl bg-[#9FE8FA]/10 border border-[#9FE8FA]/20 flex items-center justify-center text-[#9FE8FA] font-mono-label font-bold text-[#9FE8FA]ase flex-shrink-0">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="text-xl font-bold font-serif-heading text-[#E2F8FC]">
                      {stage.title}
                    </h3>
                    <span className="text-xs font-mono-label font-bold text-[#9FE8FA] bg-[#9FE8FA]/10 px-2.5 py-1 rounded-full border border-[#9FE8FA]/20">
                      AUTOMATED
                    </span>
                  </div>
                  <p className="text-sm sm:text-[#9FE8FA]ase text-[#678B94] leading-relaxed">
                    {stage.desc}
                  </p>
                </div>
              </div>
