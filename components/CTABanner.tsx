      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-[#8FE1F4] text-white rounded-3xl p-10 sm:p-16 shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#0E1B20]/10 text-white text-xs font-mono-label">
            ...
            <div className="pt-4">
              <Link
                href="/auth/signup"
                className="bg-[#0E1B20] text-[#8FE1F4] hover:bg-transparent rounded-full font-bold px-8 py-4 text-[#8FE1F4]ase inline-flex items-center gap-2 shadow-md transition-all hover:scale-105"
              >
