        ...
        <div className="bg-[#0F6F8A] text-white rounded-3xl p-10 sm:p-16 shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <div className="pt-4">
              <Link
                href="/auth/signup"
                className="bg-white text-[#0F6F8A] hover:bg-transparent rounded-full font-bold px-8 py-4 text-[#0F6F8A]ase inline-flex items-center gap-2 shadow-md transition-all hover:scale-105"
              >
