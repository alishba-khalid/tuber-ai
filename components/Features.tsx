    ...
    <section className="py-20 bg-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-[#8FE1F4]ase sm:text-lg text-[#7FA0AB] leading-relaxed">
        ...
        <div className="bg-[#0E1B20] border border-[#172B33] rounded-3xl p-8 sm:p-12 shadow-2xs relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold font-serif-heading text-[#E6F3F7]">
                Publish Illustrated E-books & PDFs Alongside Your Videos
              </h3>

              <p className="text-[#7FA0AB] leading-relaxed text-sm sm:text-[#8FE1F4]ase">
            ...
            <div className="lg:col-span-5 relative">
              <div className="bg-transparent border border-[#172B33] rounded-2xl p-6 shadow-inner relative">
