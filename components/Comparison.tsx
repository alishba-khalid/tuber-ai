  ...
  return (
    <section className="py-20 bg-transparent border-t border-[#E5E2D8]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Comparison Table */}
        <div className="bg-[#FFFFFF] border border-[#E5E2D8] rounded-2xl overflow-hidden shadow-2xs">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-transparent border-b border-[#E5E2D8]">
                  <th className="py-4 px-6 text-xs font-mono-label font-bold text-[#71717A] uppercase">
                    Capability
                  </th>
                  <th className="py-4 px-6 text-sm font-bold font-serif-heading text-[#1E1B4B] bg-[#EEF2FF]/60 w-1/3 border-x border-[#E5E2D8]">
                    TuberAI
                  </th>
              ...
              <tbody className="divide-y divide-[#E5E2D8]">
                {comparisons.map((item) => (
                  <tr key={item.feature} className="hover:bg-transparent/50 transition-colors">
                    <td className="py-5 px-6 font-semibold text-sm text-[#18181B]">
                      {item.feature}
                    </td>
                    <td className="py-5 px-6 text-sm font-medium text-[#1E1B4B] bg-[#EEF2FF]/20 border-x border-[#E5E2D8]">
                      <div className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-[#1E1B4B] flex-shrink-0" />
