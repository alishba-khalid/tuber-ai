...
export default function Comparison() {
  return (
    <section className="py-20 bg-transparent border-t border-[#222B3C]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Comparison Table */}
        <div className="bg-[#151B26] border border-[#222B3C] rounded-2xl overflow-hidden shadow-2xs">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-transparent border-b border-[#222B3C]">
                  <th className="py-4 px-6 text-xs font-mono-label font-bold text-[#64748B] uppercase">
                    Capability
                  </th>
                  <th className="py-4 px-6 text-sm font-bold font-serif-heading text-[#818CF8] bg-[#6366F1]/10/60 w-1/3 border-x border-[#222B3C]">
                    TuberAI
                  </th>
                  <th className="py-4 px-6 text-xs font-mono-label font-bold text-[#64748B] uppercase w-1/3">
              ...
              <tbody className="divide-y divide-[#222B3C]">
                {comparisons.map((item) => (
                  <tr key={item.feature} className="hover:bg-transparent/50 transition-colors">
                    <td className="py-5 px-6 font-semibold text-sm text-[#F8FAFC]">
                      {item.feature}
                    </td>
                    <td className="py-5 px-6 text-sm font-medium text-[#818CF8] bg-[#6366F1]/10/20 border-x border-[#222B3C]">
