...
export default function Comparison() {
  return (
    <section className="py-20 bg-transparent border-t border-[#2D2A26]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-[#E28C38]ase sm:text-lg text-[#A19E95]">
        ...
        {/* Comparison Table */}
        <div className="bg-[#1E1D1A] border border-[#2D2A26] rounded-2xl overflow-hidden shadow-2xs">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-transparent border-b border-[#2D2A26]">
                  <th className="py-4 px-6 text-xs font-mono-label font-bold text-[#6E6B65] uppercase">
                    Capability
                  </th>
                  <th className="py-4 px-6 text-sm font-bold font-serif-heading text-[#E28C38] bg-[#E28C38]/10/60 w-1/3 border-x border-[#2D2A26]">
                    TuberAI
                  </th>
                  <th className="py-4 px-6 text-xs font-mono-label font-bold text-[#6E6B65] uppercase w-1/3">
              ...
              <tbody className="divide-y divide-[#2D2A26]">
                {comparisons.map((item) => (
                  <tr key={item.feature} className="hover:bg-transparent/50 transition-colors">
                    <td className="py-5 px-6 font-semibold text-sm text-[#F9F9F8]">
                      {item.feature}
                    </td>
                    <td className="py-5 px-6 text-sm font-medium text-[#E28C38] bg-[#E28C38]/10/20 border-x border-[#2D2A26]">
                      <div className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-[#E28C38] flex-shrink-0" />
                        <span>{item.tuber}</span>
                      </div>
                    </td>
                    <td className="py-5 px-6 text-sm text-[#6E6B65]">
                      <div className="flex items-center gap-2">
