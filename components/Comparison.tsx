  ...
  return (
    <section className="py-20 bg-transparent border-t border-[#1E434F]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Comparison Table */}
        <div className="bg-[#0D2229] border border-[#1E434F] rounded-2xl overflow-hidden shadow-2xs">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-transparent border-b border-[#1E434F]">
                  <th className="py-4 px-6 text-xs font-mono-label font-bold text-[#5D8390] uppercase">
                    Capability
                  </th>
                  <th className="py-4 px-6 text-sm font-bold font-serif-heading text-[#8FE1F4] bg-[#8FE1F4]/10/60 w-1/3 border-x border-[#1E434F]">
                    TuberAI
                  </th>
                  <th className="py-4 px-6 text-xs font-mono-label font-bold text-[#5D8390] uppercase w-1/3">
                    Other AI Video Tools
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#1E434F]">
                {comparisons.map((item) => (
                  <tr key={item.feature} className="hover:bg-transparent/50 transition-colors">
                    ...
                    <td className="py-5 px-6 text-sm font-medium text-[#8FE1F4] bg-[#8FE1F4]/10/20 border-x border-[#1E434F]">
                      <div className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-[#8FE1F4] flex-shrink-0" />
                        <span>{item.tuber}</span>
                      </div>
                    </td>
                    <td className="py-5 px-6 text-sm text-[#5D8390]">
                      <div className="flex items-center gap-2">
