...
export default function Pricing() {
  return (
    <section id="pricing" className="py-20 bg-transparent border-t border-[#9CB4BD]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="text-[#0F6F8A]ase sm:text-lg text-[#425E67] leading-relaxed mb-6">
          ...
          <div className="bg-white border border-[#9CB4BD] p-4 rounded-xl text-xs sm:text-sm text-[#425E67] inline-block shadow-2xs">
            <span className="font-semibold text-[#06151A]">The old way:</span> $300–$1,000 per video with a freelance team. TuberAI does the whole thing for a few dollars — while you sleep.
          </div>
        </div>
            ...
            <div
              ...
              className={`rounded-2xl p-6 flex flex-col justify-between transition-all relative ${
                plan.popular
                  ...
                  : 'bg-white border border-[#9CB4BD] shadow-2xs hover:border-[#7E9BA6]'
              }`}
            >
              {plan.popular && (
              ...
              <div>
                <div className="flex items-center justify-between mb-2 mt-1">
                  <h3 className="text-lg font-bold font-serif-heading text-[#06151A]">
                    {plan.name}
                  </h3>
                  {plan.savings && (
                ...
                <div className="mb-4">
                  <span className="text-3xl font-extrabold font-serif-heading text-[#06151A]">
                    ${plan.price}
                  </span>
                  <span className="text-xs text-[#68858E]"> / month</span>
                </div>

                <div className="space-y-3 text-xs text-[#425E67] border-t border-[#9CB4BD] pt-4 mb-6">
                  <div className="flex items-center gap-2 font-semibold text-[#06151A]">
                  ...
                  <div className="text-[11px] text-[#68858E] leading-relaxed pt-1">
