...
export default function Pricing() {
  return (
    <section id="pricing" className="py-20 bg-transparent border-t border-[#27272A]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="text-[#FFFFFF]ase sm:text-lg text-[#A1A1AA] leading-relaxed mb-6">
          ...
          <div className="bg-[#18181B] border border-[#27272A] p-4 rounded-xl text-xs sm:text-sm text-[#A1A1AA] inline-block shadow-2xs">
            <span className="font-semibold text-[#FAFAFA]">The old way:</span> $300–$1,000 per video with a freelance team. TuberAI does the whole thing for a few dollars — while you sleep.
          </div>
        </div>
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`rounded-2xl p-6 flex flex-col justify-between transition-all relative ${
                plan.popular
                  ? 'bg-[#18181B] border-2 border-[#0F6F8A] shadow-md'
                  : 'bg-[#18181B] border border-[#27272A] shadow-2xs hover:border-[#3F3F46]'
              }`}
            >
              {plan.popular && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-[#FFFFFF] text-[#09090B] text-[10px] font-mono-label font-bold px-3 py-1 rounded-full uppercase tracking-wider shadow-xs">
                  BEST VALUE
                </div>
              )}
              ...
              <div>
                <div className="flex items-center justify-between mb-2 mt-1">
                  <h3 className="text-lg font-bold font-serif-heading text-[#FAFAFA]">
                    {plan.name}
                  </h3>
                  {plan.savings && (
                    <span className="text-[10px] font-mono-label font-semibold text-[#FFFFFF] bg-[#FFFFFF]/10 px-2 py-0.5 rounded border border-[#FFFFFF]/20">
                      {plan.savings}
                    </span>
                  )}
                </div>
                ...
                <div className="mb-4">
                  <span className="text-[#09090B]xl font-extrabold font-serif-heading text-[#FAFAFA]">
                    ${plan.price}
                  </span>
                  <span className="text-xs text-[#71717A]"> / month</span>
                </div>

                <div className="space-y-3 text-xs text-[#A1A1AA] border-t border-[#27272A] pt-4 mb-6">
