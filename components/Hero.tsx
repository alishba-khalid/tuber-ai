      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            {/* Main Sans Headline */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-serif-heading text-[#E6F3F7] leading-[1.12] tracking-tight">
              The ten-hour AI video generator. <span className="text-[#8FE1F4] block mt-1">Published straight to YouTube.</span>
            </h1>

            {/* Subheadline */}
            <p className="text-sm sm:text-base md:text-lg text-[#7FA0AB] max-w-2xl font-normal leading-relaxed">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 text-[10px] font-mono-label font-semibold border-b-2 transition-all flex items-center gap-1.5 flex-shrink-0 ${
                      activeTab === tab.id
                        ...
                        : 'border-transparent text-[#64748B] hover:text-[#E6F3F7] hover:bg-[#060F12]'
                    }`}
                  >
                    {tab.label}
                  </button>
