        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="flex flex-wrap gap-2.5 pt-4">
              {subHeroChips.map((chip) => (
                <span
                  key={chip}
                  className="px-3.5 py-1.5 rounded-full text-xs font-medium text-[#678B94] bg-[#0B1E24] border border-[#133038]"
                >
                  ✓ {chip}
                </span>
              ))}
          ...
          <div className="lg:col-span-5 w-full">
            <div className="bg-[#0B1E24] border border-[#133038] rounded-2xl shadow-sm overflow-hidden">
              ...
              {/* Widget Header Bar */}
              <div className="bg-[#061216] border-b border-[#133038] px-4 py-3 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#9FE8FA]" />
                  <span className="text-[10px] font-mono-label font-bold text-[#E2F8FC] uppercase">
                ...
                {chapterTabs.map((tab) => (
                  <button
                    ...
                    className={`px-3 py-2 text-[10px] font-mono-label font-semibold border-b-2 transition-all flex items-center gap-1.5 flex-shrink-0 ${
                      activeTab === tab.id
                        ? 'border-[#9FE8FA] text-[#9FE8FA] bg-[#0B1E24]/60'
                        : 'border-transparent text-[#64748B] hover:text-[#E2F8FC] hover:bg-[#061216]'
                    }`}
                  >
                    {tab.label}
                  </button>
              ...
              <div className="p-4 bg-[#0B1E24] space-y-4">
                
                {/* Visual Thumbnail */}
                <div className="relative aspect-video rounded-xl overflow-hidden bg-[#061216] border border-[#133038] group">
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-[#9FE8FA] text-[#061216] flex items-center justify-center shadow-md">
                      <Play className="w-4 h-4 fill-current ml-0.5" />
                    </div>
                  </button>

                  <div className="absolute bottom-2.5 left-2.5 z-20 text-[#E2F8FC] text-xs font-medium">
                    <span className="bg-[#9FE8FA]/20 border border-[#9FE8FA]/40 text-[#9FE8FA] text-[9px] px-1.5 py-0.5 rounded-full mr-1.5 font-mono-label">SCENE 14</span>
                ...
                <div className="space-y-3">
                  <div>
                    <div className="text-[10px] font-mono-label text-[#9FE8FA] font-semibold mb-0.5">
                      ACTIVE NARRATION SCRIPT
                    </div>
                    <h3 className="text-sm font-bold text-[#E2F8FC]">
                      {selectedChapter.title}
                    </h3>
                  </div>

                  <p className="text-xs text-[#678B94] leading-relaxed italic border-l-2 border-[#9FE8FA] pl-3 py-0.5">
                  ...
                  {/* Audio Waveform */}
                  <div className="bg-[#061216] p-3 rounded-xl border border-[#133038] space-y-1.5">
