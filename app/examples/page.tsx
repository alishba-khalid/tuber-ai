              ...
              <div key={ex.id} className="glass-card glass-card-hover overflow-hidden group cursor-pointer">
                ...
                <div className={`h-44 bg-gradient-to-br ${ex.thumbnail_color} flex items-center justify-center relative`}>
                  ...
                  <div className="relative z-10 w-14 h-14 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center group-hover:scale-110 transition-transform">
                    <Play className="w-6 h-6 text-[#E6F2F5] fill-white ml-0.5" />
                  </div>
                  {/* Duration badge */}
                  <div className="absolute bottom-3 right-3 bg-black/70 text-[#E6F2F5] text-xs font-medium px-2 py-1 rounded-md">
                    {ex.duration}
                  </div>
                  {/* Format badge */}
                  <div className="absolute top-3 left-3 bg-[#6C3DFF]/80 text-[#E6F2F5] text-xs font-medium px-2 py-1 rounded-md">
                    {ex.format}
                  </div>
                </div>
                ...
                {/* Info */}
                <div className="p-4">
                  <h3 className="text-sm font-bold text-[#E6F2F5] mb-2 line-clamp-2">{ex.title}</h3>
                  <p className="text-xs text-[#74969E] leading-relaxed mb-3 line-clamp-2">{ex.description}</p>
