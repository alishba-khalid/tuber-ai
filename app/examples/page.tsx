    ...
    <main className="min-h-screen">
      ...
      <div className="pt-24 pb-16">
        ...
        <div className="text-center py-16 max-w-3xl mx-auto px-4">
          ...
          <p className="text-[#425E67] text-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {examples.map((ex) => (
              <div key={ex.id} className="glass-card glass-card-hover overflow-hidden group cursor-pointer">
                ...
                <div className="p-4">
                  ...
                  <p className="text-xs text-[#68858E] leading-relaxed mb-3 line-clamp-2">{ex.description}</p>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-[#68858E] text-sm mt-3">No credit card required. Free to get started.</p>
          </div>
        </div>
