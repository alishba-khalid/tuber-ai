    ...
    <main className="min-h-screen">
      ...
      <div className="pt-24 pb-16">
        ...
        <div className="text-center py-16 max-w-3xl mx-auto px-4">
          ...
          <p className="text-[#4B6E7A] text-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {examples.map((ex) => (
              <div key={ex.id} className="glass-card glass-card-hover overflow-hidden group cursor-pointer">
                ...
                <div className={`h-44 bg-gradient-to-br ${ex.thumbnail_color} flex items-center justify-center relative`}>
                  ...
                  <div className="relative z-10 w-14 h-14 rounded-full bg-[#FFFFFF]/20 backdrop-blur-sm flex items-center justify-center group-hover:scale-110 transition-transform">
                  ...
                  {/* Format badge */}
                  <div className="absolute top-3 left-3 bg-[#6C3DFF]/80 text-white text-xs font-medium px-2 py-1 rounded-md">
                    {ex.format}
                  </div>
                </div>
                ...
                <div className="p-4">
                  ...
                  <p className="text-xs text-[#7A9CA8] leading-relaxed mb-3 line-clamp-2">{ex.description}</p>
          ...
          <div className="text-center mt-12">
            <Link href="/auth/signup" className="btn-primary px-8 py-4 text-[#0F6F8A]ase inline-flex items-center gap-2">
              Start Creating Your Videos →
            </Link>
            <p className="text-[#7A9CA8] text-sm mt-3">No credit card required. Free to get started.</p>
          </div>
        </div>
