      ...
      <div className="max-w-md w-full bg-[#17181F] border border-[#2A2C35] rounded-2xl p-8 shadow-xs">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              <label className="text-xs font-mono-label font-bold text-[#9CA3AF]">
                PASSWORD
              </label>
              <Link href="#" className="text-[11px] text-[#F97316] font-semibold hover:underline">
                Forgot password?
              </Link>
            </div>
            <input
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-[#17181F] px-3 text-[#6B7280] font-medium">Or continue with</span>
          </div>
        </div>
