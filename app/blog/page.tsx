      ...
      <div className="pt-24 pb-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center py-16">
            ...
            <p className="text-[#4B6E7A] text-lg max-w-xl mx-auto">
              ...
              <Link key={post.slug} href={`/blog/${post.slug}`}>
                <div className="glass-card glass-card-hover p-6 flex flex-col sm:flex-row gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[#4B6E7A] text-sm leading-relaxed mb-4">{post.excerpt}</p>
                    <div className="flex items-center gap-4 text-xs text-[#7A9CA8]">
                  ...
                  <ArrowRight className="w-5 h-5 text-[#7A9CA8] flex-shrink-0 self-center hidden sm:block" />
                </div>
              </Link>
            ))}
          </div>
