...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { heading: 'Pricing model', body: 'InVideo\'s free and lower tiers carry watermarks and export limits, with full features gated behind higher subscription tiers. GenByGhost uses a pay-as-you-go credit model instead — no subscription, no watermark tiers, you buy credits and spend them on generation.' },
